...
(function (global, factory) {
   ...
   * a clip function
   *
   * this one doesn't do anything but complies with the preclip API
   * 
   */

  function clipNone(rotate, stream) {
    var _stream = {
       point: function(x,y) {
         var r = rotate(x,y);
  ...
  */
  ...
  function projectionMutator(projectAt) {
    ...
    projection.clipAngle = function(_) {
      return arguments.length ? (preclip = +_ > 0 ? clipCircle(theta = _ * radians, 6 * radians) : (theta = null, clipNone), reset()) : theta * degrees;
    };
